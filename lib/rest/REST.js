    ...
    _.each(modelDefinition.entities, function(entityDefinition) {
        ...
        if (entityDefinition.access.allow['query'].length) {
            ...
            var queryHandler = function(req, res, next) {
                ...
                function parseJSONParameter(paramName) {
                ...
                function parseIntegerParameter(paramName) {
                    if (req.query[paramName]) {
                ...
                try {
                    var queryData = { };
                    queryData.where = parseJSONParameter('where');
                    queryData.sort = parseJSONParameter('sort');
                    queryData.include = parseJSONParameter('include');
                    queryData.offset = parseIntegerParameter('offset');
                    queryData.limit = parseIntegerParameter('limit');
