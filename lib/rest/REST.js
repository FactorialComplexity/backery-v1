...
module.exports = function(application, config) {
    ...
    if (twitterAuthMethod) {
        oauth.enableTwitter(function(req, callback) {
            if (!req.body.twitter_access_token || !req.body.twitter_access_token_secret) {
                callback(new new errors.BackeryInvalidParametersError('Expected but missing: twitter access tokens'));
            } else {
                var createRequest = new requests.CreateOrUpdateRequest(application.Backery.Model.User, undefined, {},
                    undefined, undefined, undefined, application.Backery,
                    function(createdUser) {
    ...
    if (googleAuthMethod) {
        oauth.enableTwitter(function(req, callback) {
            if (!req.body.twitter_access_token || !req.body.twitter_access_token_secret) {
                callback(new new errors.BackeryInvalidParametersError('Expected but missing: google access tokens'));
            } else {
                var createRequest = new requests.CreateOrUpdateRequest(application.Backery.Model.User, undefined, {},
                    undefined, undefined, undefined, application.Backery,
                    function(createdUser) {
                        createdUser.setGooglerUserId(googleUserId);
                    });
                var createdUser, googleUserId;
                application.validateGoogleToken(req.body.twitter_access_token, req.body.twitter_access_token_secret).then(function(agoogleUserId) {
