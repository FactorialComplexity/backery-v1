    ...
    api.post('/batch', function(req, res, next) {
        ...
        try {
            _.each(sortedKeys, function(key) {
                if (key.match(/\.json$/)) {
                    ...
                    var preserveName = json.body._preserveName;
                    delete json.body._preserveName;
        ...
        router.runInContext(req.user, function() {
            ...
            application.Backery.Promise.mapSeries(requests, function(request) {
                ...
                return application.processRequest(applicationRequest, { clientId: req.clientId }).then(function(responseStruct) {
                    if (request.type == 'create') {
