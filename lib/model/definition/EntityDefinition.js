 ...
 */
EntityDefinition.prototype.prepareValues = function(values, Backer, isForCreate) {
    var self = this;
    var invalidFields = [];
    var converted = {};
    ...
    _.each(values, function(value, key) {
        if (self.fields[key]) {
            if (self.fields[key].type.isString()) {
                ...
                try {
                    converted[key] = new Backer.File(value);
                } catch (error) {
                ...
                if (!_.isString(value)) {
                    ...
                    converted[key] = Backer[self.fields[key].type.realtedEntity.name].ref(value);
                }
                ...
                if (_.isObject(value) && !_.isArray(value) && !_.isFunction(value)) {
                    ...
                    try {
                        converted[key] = Backer[self.fields[key].type.relatedEntity.name].RelationOperation.load(value);
                    } catch (error) {
                    ...
                    try {
                        converted[key] = Backer[self.fields[key].type.relatedEntity.name].RelationOperation.Set(value);
                    } catch (error) {
