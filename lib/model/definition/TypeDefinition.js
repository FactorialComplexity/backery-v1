...
var TypeDefinition = function(data) {
    ...
    } else if (_.isObject(data) && data['name'] == 'String' &&
        (_.isNumber(data['limit']) || data['limit'] === 'tiny' || data['limit'] === 'medium' || data['limit'] === 'long')) {
            
        this.value = Types[data['name']];
...
TypeDefinition.prototype.isLocation = function() {
    return this.value == Types.Location;
}
