    ...
    _.each(definition.entities, function(entity, name) {
        ...
        _.each(entity.fields, function(field) {
            ...
            if (field.type.value == TypeDefinition.String) {
                if (_.isNumber(field.type.limit)) {
                    value = {
                    ...
                    value = { type: Sequelize.TEXT(field.type.limit), defaultValue: null };
                }
                ...
                value = { type: Sequelize.TEXT(field.type.limit || undefined), defaultValue: null };
