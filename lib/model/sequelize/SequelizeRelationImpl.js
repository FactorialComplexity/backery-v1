...
var SequelizeRelationImpl = function(objectImpl, fieldDefinition, sequelizeModel, include) {
    ...
    this.Promise = sequelizeModel.Backer.Promise;
    ...
    self._fetched = eagerLoaded ? _.map(eagerLoaded, function(sequelizeInstance) {
        return new BackeryObject(new self.SequelizeObjectImpl(sequelizeInstance, self.definition.type.relatedEntity, self.sequelizeModel));
    }) : undefined;
