...
SequelizeModel.prototype.authUser = function(method, params) {
    ...
    if (method == 'password') {
        ...
        return new self.Backery.Promise(function(resolve, reject) {
            ...
            if (sequelizeInstance.get('blocked')) {
                return self.Backery.Promise.reject(new errors.BackeryUnauthorizedError('User is blocked', 'UserIsBlocked'));
            }
        ...
        return new self.Backery.Promise(function(resolve, reject) {
            ...
            self._sequelizeModels.User.findOne({ where: query }).then(function(sequelizeInstance) {
                if (sequelizeInstance && sequelizeInstance.get('blocked')) {
                    reject(new errors.BackeryUnauthorizedError('User is blocked', 'UserIsBlocked'));
                } else {
                    resolve(sequelizeInstance);
                }
            }, function(error) {
