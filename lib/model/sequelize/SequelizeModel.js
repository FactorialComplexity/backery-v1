...
SequelizeModel.prototype.define = function(definition, Promise, databaseURI, databaseOptions) {
        ...
        return new Promise(function(resolve, reject) {
            sequelizePromise.then(function(res) {
                ...
                if (error.name == 'SequelizeForeignKeyConstraintError') {
                    reason = 'BackerObjectsNotFound';
                }
                                
                reject(new errors.BackerDatabaseError(error, reason));
            });
        });
    }
    ...
    _.each(definition.entities, function(entity, name) {
        ...
        self.entities[entity.name] = new BackerEntity(self._definition.entities[entity.name],
...
SequelizeModel.prototype._object = function(sequelizeInstance, entityDefinition) {
    ...
    return new BackerObject(new SequelizeObjectImpl(sequelizeInstance, entityDefinition, {
        model: this,
