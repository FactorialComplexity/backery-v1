...
var SequelizeObjectImpl = function(sequelizeInstance, entityDefinition, sequelizeModel, include, isRef, afterFetchCallbackInstaller) {
    ...
    this.relationsOneValues = { };
    this.relationsOnePrevious = { };
    ...
    if (afterFetchCallbackInstaller) {
        ...
        self._startAfterFetchCascade(include, afterFetchCallbackInstaller);
    } else {
...
SequelizeObjectImpl.prototype._startAfterFetchCascade = function(include, callbackInstaller) {
    var self = this;
    var objectGroups = [];
