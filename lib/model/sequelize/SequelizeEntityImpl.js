...
SequelizeEntityImpl.prototype.ref = function(id, values) {
    var sequelizeInstance = this.sequelizeEntityModel.build(_.extend({ id: parseInt(id) }), { isNewRecord : false });
    var object = this.sequelizeModel.createBackeryObject(sequelizeInstance, this.definition, undefined, true);
...
SequelizeEntityImpl.prototype.load = function(values) {
    ...
    return this.sequelizeModel.createBackeryObject(sequelizeInstance, this.definition);
}
