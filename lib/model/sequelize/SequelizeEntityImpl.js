...
SequelizeEntityImpl.prototype.create = function(values) {
    ...
    var sequelizeInstance = this.sequelizeEntityModel.build(values ? values : {});
...
SequelizeEntityImpl.prototype.query = function() {
    return new BackeryQuery(this, new SequelizeQueryImpl(this.definition, this.sequelizeEntityModel, this.sequelizeModel),
        this.sequelizeModel.Backery);
}
