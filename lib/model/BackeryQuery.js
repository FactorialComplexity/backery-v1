...
var BackeryQuery = function(impl, relatedToObject, Backery) {
    var pimpl = impl;
    ...
    Object.defineProperty(this, 'relatedFieldDefinition', { get: function() { return impl.getRelatedFieldDefinition(); } });
    
    this.isRelationQuery = function() {
        return !!self.relatedToObject;
    }
    ...
    this.include = function(include, includeFiles) {
        ...
        //console.log(JSON.stringify(includeValue))
        return self;
    }
