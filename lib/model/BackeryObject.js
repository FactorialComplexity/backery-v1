        ...
        if (!self.isRef()) {
            _.each(definition.fields, function(field) {
                if (field.type.isRelation()) {
                    ...
                    if (includeField) {
                        if (field.type.isRelationMany() && hasAccess(field, user)) {
                        ...
                        } else if (field.type.isRelationOne() && hasAccess(field, user)) {
                    ...
                    if (!_.isUndefined(value) && hasAccess(field, user)) {
