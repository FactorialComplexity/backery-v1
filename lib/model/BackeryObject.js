...
var BackeryObject = function(impl, Backery, databaseHooks) {
    ...
    // Fetches object data from the perstistent storage, discarding any updates made to the object
    // if the data was never fetched before.
    // Returns Backery.Promise
    ...
    this.save = function() {
        ...
        var wasChanged, wasNew;
        return databaseHooks.beforeSave(self).then(function() {
            wasChanged = { };
            wasNew = self.isNew();
            ...
            return databaseHooks.afterSave(self);
        });
    }
    ...
    this.wasNew = function() {
        return _wasNew;
    }
    
    this.wasChanged = function(key) {
        return !_.isUndefined(_wasChanged) ? !!_wasChanged[key] : undefined;
    }
    
    this.wasNewOrChanged = function(key) {
        return self.wasNew() || self.wasChanged(key);
    }
