    ...
    Push: {
        send: function(whereInstallation, payload, queue) {
            if (_.isString(whereInstallation)) {
                whereInstallation = { user: whereInstallation };
            }
...
Backery.Error = _.extend(Backery.Error,
{
    ...
    Unauthorized: function(message) {
        Object.defineProperty(this, 'name', { get: function() { return 'BackeryUnauthorizedError'; } });
        Object.defineProperty(this, 'status', { get: function() { return 401; } });
        Object.defineProperty(this, 'message', { get: function() {
            return message || 'User should be authorized to perform this operation';
        }});
    }
});
