...
var BackeryStructObject = function(entityName, objectId, isRef) {
    ...
    var _createdAt, _updatedAt, _disabledAt;
    ...
    Object.defineProperty(this, 'disabledAt', {
        get: function() { return _disabledAt.value; },
        set: function(value) { _disabledAt = structs.Date.wrap(value); }
    });
    ...
    this.toJSON = function(verbose) {
        ...
        if (_.isNull(_objectId)) {
            ...
            if (_objectId && isRef) {
                ...
                if (_disabledAt) {
                    json.disabledAt = _disabledAt.toJSON(verbose);
                }
            }
        }
