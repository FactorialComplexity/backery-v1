...
function isBackeryStruct(value) {
    return _.isString(value.type) && _.isFunction(value.toJSON);
}

function isBackeryStructObject(value) {
...
function defineSimpleStruct(options) {
    ...
    BackeryStructType.fromJSON = function(json) {
    ...
    BackeryStructType.wrap = function(value) {
        if (isBackeryStruct(value) && value.type === options.type && !_.isUndefined(value.value)) {
...
var BackeryStructCollection = function(entityName, objects, count, offset, limit) {
    ...
    this.setObjects = function(objects) {
        _.each(objects, function(object) {
            if (!isBackeryStructObject(object)) {
...
structs.fromJSON = function(json, entityName, model) {
    ...
    if (_.isObject(json['__type'])) {
        ...
        try {
            return StructObject.fromJSON(json['__type']);
        } catch (error) {
...
/// serialized verbose BackeryObject deserialized into BacakeryStruct.Object in-place.
