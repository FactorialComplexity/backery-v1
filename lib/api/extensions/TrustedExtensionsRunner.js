...
var TrustedExtensionsRunner = function(rootFilePath, applicationName, customConfig, Backery) {
    ...
    if (rootFilePath) {
        ...
        extensionsInstaller.express = function() {
            return express.apply(this, arguments);
        }
        
        extensionsInstaller.express.static = function () {
        ...
        extensionsInstaller.express.Router = express.Router;
