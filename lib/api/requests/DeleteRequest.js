...
var DeleteRequest = function(entity, objectId, Backer) {
    var _entity = entity;
    var _objectId = objectId;
    ...
    this.execute = function(doNotFetch) {
        return (doNotFetch ? Backer.Promise.resolve(_entity.ref(_objectId)) : _entity.get(_objectId)).then(function(object) {
            if (object) {
            ...
            return Backer.Promise.resolve(new DeleteResponse(_objectId));
        });
    }
}
