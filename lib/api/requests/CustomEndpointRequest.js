var CustomEndpointRequest = function(method, endpoint, path, params, body, verbose, user, Backery) {
    ...
    Object.defineProperty(this, 'verbose', { get: function() { return verbose; } });
