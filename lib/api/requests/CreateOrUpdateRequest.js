...
var CreateOrUpdateRequest = function(entity, objectId, values, file, include, user, Backery) {
        ...
        if (_objectId) {
            ...
            if (file) {
                if (_.isFunction(_object.setFileBody))
                    ...
                    return new errors.BackeryInvalidParametersError('Cannot set file body for entity `' + entity.name + '`');
            } 
        }
    } catch (error) {
