...
var TrustedExtensionsRunner = function(rootFilePath, applicationName, customConfig, Backery) {
    ...
    function socketNamespacesCollector() {
        if (!_installing) {
            throw new Error('Cannot install new handler after extension code was already loaded');
        }

        return function(namespace, handler) {
            return Object.assign(_socketNamespaces, {
                [namespace]: handler
            })
        }
    }
    ...
    if (rootFilePath) {
        var extensionsInstaller = {
            ...
            sockets: socketNamespacesCollector(),
    ...
    self.getSocketNamespaces = function() {
        return _socketNamespaces;
    }
